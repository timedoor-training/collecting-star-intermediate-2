...
export default class CollectingStarScene extends Phaser.Scene
{
    ...
    create() {
        ...
        this.anims.create({
            ...
            { start: 0, end: 3 }), //frame yang digunakan
            frameRate: 10,
            repeat: -1 
        });
            ...
            stars.children.iterate(function (child) {
                // memberikan ikan efek memantul dengan nilai antara 0.4 - 0.8
                child.setBounceY(Phaser.Math.FloatBetween(0.4, 0.8));
            });

            // star collide with platform
            this.physics.add.collider(stars, platforms)

            this.physics.add.overlap(player, // membuat overlap antara player
                stars, // dan stars
            ...
            // looping semua bintang menjadi enable body
            // code enableBody ikuti petunjuk dibawah
            // child.enableBody(
            // status reset,-> berisi true/false
            // x, -> posisi x
            // y, -> posisi y
            // status enableGameObject,-> berisi true/false
            // status showGameObject -> berisi true/false
            // )
            stars.children.iterate(function (child) {
